...
IF ~~ 21
  ...
  IF ~~ THEN REPLY @50 /* Very well, we will take on these drow on together. */ DO ~SetGlobal("ZB_NEPHY_JOINS","GLOBAL",1)~ GOTO 18
  IF ~~ THEN REPLY @55 /* We don't need any dead weight. */ GOTO 19
  IF ~~ THEN REPLY @56 /* We'll be fine, I have no fear of drow. */  DO ~SetGlobal("ZB_NEPHY_JOINS","GLOBAL",1)~ GOTO 20
END

IF ~Global("ZB_NEPH_INTRO_RESPONSE","GLOBAL",11)~ 22 
  SAY @57 /* Excellent! An appropriate death to our enemies. Let us speak of escape if you wish it. */
  IF ~~ THEN REPLY @58 /* I wish to discuss escaping the Pits of Despair. */ DO ~SetGlobal("ZB_NEPH_INTRO_RESPONSE","GLOBAL",12)~ GOTO 23
END
