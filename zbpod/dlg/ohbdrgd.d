...
~ THEN BEGIN 0
  SAY ~Captain said you can pass. Go on, he's waiting for you.~
  IF ~~ THEN EXIT
END
...
~ THEN BEGIN 1
  SAY ~You must be one of the new Nosers. Come on in. They'll be expecting you upstairs.~
...
HasItemEquiped("ohbnoshu",LastTalkedToBy)
~ THEN BEGIN 2
  SAY ~You again. I see they're keeping you busy up there. Come on in.~
  IF ~~ THEN EXIT
END

IF ~  True()
~ THEN BEGIN 3
  SAY ~Only Master Dennaton, the Planar Hunters, and their servants are allowed through here. Go back the way you came.~
